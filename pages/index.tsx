...
const Home: NextPage<HomeProps> = ({categories, products}) => {
    ...
    return (
        <div>
            ...
            <section className = "relative z-40 -mx-[100vh] min-h-screen bg-[#1b1b1b]">
                        ...
                        <Tab.List className = "flex justify-center">
                            {
                                categories.map((category) => (
                                    <Tab
                                        key = {category._id}
                                        id= {category._id}
                                        className = {({selected}) => `whitespace-nowrap rounded-t-lg py-3 text-xm font-light outline-none md:py-4 md:px-6 md:text-base 
